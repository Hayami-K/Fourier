...
public class Fourier1dModel extends FourierModel {
	...
	public void actionPerformed(ActionEvent anActionEvent) {
		...
		interactivePowerSpectrumPaneModel.picture(FourierModel
				.generateImageForSpectrum(aTransformation.swap(interactivePowerSpectrum)));
		interactivePowerSpectrumPaneModel.changed();

		computeInverseData();
		interactiveDataPaneModel
				.picture(FourierModel.generateImageForData(inverseData));
	...
	public void computeFromPoint(Point aPoint, boolean isAltDown) {
		...
		// System.out.printf("x:%d, swapX:%d -:%d\n", x, intSwap(x), Math.abs(x -
		// previousX));
	...
	public void computeInverseData() {
		DiscreteFourier1dTransformation anInverseTransform = new DiscreteFourier1dTransformation(interactiveRealPart,
				interactiveImaginaryPart);
	...
	public void doAllSpectrum() {
		...
		interactiveImaginaryPart = imaginaryPart;
	...
	public void mouseDragged(Point aPoint, MouseEvent aMouseEvent) {
		...
		this.computeFromPoint(aPoint, aMouseEvent.isAltDown());
